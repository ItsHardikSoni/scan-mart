...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const handleLogout = async () => {
        ...
        try {
            const { clearAdminSession } = await import('@/app/actions/auth');
                    ...
                    <div className="h-16 flex items-center px-6 border-b border-border/50">
                        <Link href="/admin/dashboard" className="flex items-center gap-2 group">
                            ...
                            <div className="leading-none">
                                ...
                                <span className="text-[8px] text-primary font-bold uppercase tracking-widest">Control Center</span>
                            </div>
                        </Link>
                        <button
                            onClick={() => setSidebarOpen(false)}
                ...
                <header className="h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 bg-card/50 backdrop-blur-md border-b border-border/50 sticky top-0 z-30">
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        <h2 className="text-sm font-semibold text-foreground capitalize">
                            Admin / {pathname.split('/').pop() === 'dashboard' ? 'Overview' : pathname.split('/').pop()}
                        </h2>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="h-8 w-8 rounded-full bg-primary/20 flex items-center justify-center text-primary shadow-inner border border-primary/20">
                                    <ShieldCheck className="h-4 w-4" />
                                </div>
